...
ÉTAPE 5 — CONSIGNE D'ÉCRITURE LIBÉRATRICE
Génère UNE consigne d'écriture libératrice adaptée à ce que l'utilisateur a exprimé. Type "lettre que tu n'enverras jamais", ou "écris ce que tu n'as jamais osé dire". Doit être personnalisée à sa situation. 1 phrase courte et puissante.

ÉTAPE 6 — MICRO-ACTIONS CONCRÈTES
Génère 6 micro-actions concrètes à faire MAINTENANT dans la vraie vie, adaptées à son état émotionnel. Chaque action doit être :
- Réalisable en moins de 5 minutes
- Concrète et ancrée dans le réel (pas méditative)
- Bienveillante envers soi ou les autres
- Variée (corps, lien social, environnement, plaisir simple)

Exemples pour stress : "Bois un grand verre d'eau lentement", "Envoie un message à quelqu'un qui te fait du bien", "Sors 2 minutes prendre l'air", "Range un seul tiroir — pas plus".
...
Réponds UNIQUEMENT en JSON valide avec cette structure exacte :
{
  ...
  "writing_prompt": "1 phrase — consigne d'écriture libératrice personnalisée",
  "micro_actions": [
    "action 1 (max 15 mots)",
    "action 2",
    "action 3",
    "action 4",
    "action 5",
